...
class receiver2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_moving_average_xx_1 = blocks.moving_average_ff(1000, 0.5, 4000, 1)
        ...
        self.connect((self.blocks_moving_average_xx_0, 0), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_moving_average_xx_1, 0), (self.blocks_min_xx_0, 0))
